        ...
        <section class="container mx-auto mt-20 px-4 xl:px-16 py-10">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button
                        @click="router.back()"
                        class="px-5 py-2 text-gray-100 rounded-xl bg-gradient-to-r from-[#A3D921] to-[#046425] border border-[#046425] hover:border-[#A3D921] transition">
...
const projectLists = ref([
    ...
    // =========================
    {
        ...
        category: "Education",
        shortDesc:
        "A complete school automation system for students, teachers, classes, routines, exams, attendance, result management and fees management with expense and extra income and banking transection etc.",
    ...
    },
    {
        ...
        features: [
            ...
            "Animal Tracking and Profile",
            "Bio Gas service and payment",
